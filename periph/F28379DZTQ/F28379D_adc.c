...
void ADC_init()
{
    ...
    AdcaRegs.ADCSOC0CTL.bit.TRIGSEL = 2;    //SOC0 will begin conversion on CPU Timer 0
    ...
    AdcaRegs.ADCSOC1CTL.bit.TRIGSEL = 2;    //SOC1 will begin conversion on CPU Timer 0
