...
build-98205807:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-98205807-inproc

build-98205807-inproc: ../Lab2Idle.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-98205807 ../Lab2Idle.cfg
configPkg/compiler.opt: build-98205807
configPkg/: build-98205807
