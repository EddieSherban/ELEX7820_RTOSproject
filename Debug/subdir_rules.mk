...
build-1738277903:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1738277903-inproc

build-1738277903-inproc: ../Lab_proj_Idle.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1738277903 ../Lab_proj_Idle.cfg
configPkg/compiler.opt: build-1738277903
configPkg/: build-1738277903
